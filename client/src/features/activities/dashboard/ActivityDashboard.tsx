...
export default function ActivityDashboard({deleteActivity,submitForm,openForm, closeForm, editMode, activities, selectActivity, cancelSelectActivity, selectedActivity}: Props) {
  return (
