...
export default function ActivityDashboard({deleteActivity,openForm, closeForm, editMode, activities, selectActivity, cancelSelectActivity, selectedActivity}: Props) {
  return (
